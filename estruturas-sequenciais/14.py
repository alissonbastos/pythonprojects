...
peso = float(input('Digite o peso que foi pescado hoje:\n>>>'))
excesso = peso - 50
multa = excesso * 4.00

print(f'A quantidade por quilo pescada hoje foi de {peso}')
print(f'O excesso de peso foi de {excesso}')
print(f'Multa a ser pago por quilo excedido é de {multa}')